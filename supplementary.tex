...
\noindent\textbf{System action} (Gray809, public domain, 108~KB PNG):
\begin{lstlisting}
cl.Image(path="public/anatomy/brachial_plexus.png",
         display="inline")  # appended to reply
\end{lstlisting}
...
of the brachial plexus during the tutoring phase (consecutive\_incorrect $= 1$,
PCR mode: \texttt{context\_only}).

\noindent\textbf{System action} (\texttt{analyze\_uploaded\_image}, GPT-4o Vision):
\begin{lstlisting}
Image received: student_upload_brachial.jpg
...
\noindent\textbf{Turn 1} $|$ Source: student image upload $|$ VLM: GPT-4o Vision $|$ Leak: None\\

...
Image verification & Claude Haiku (vision) & Web diagram filtering \\
Student image VLM & GPT-4o Vision & Upload identification \\
\bottomrule
\end{tabular}
...
anatomy domains (Wikipedia, Radiopaedia, Kenhub), and Claude Haiku (vision)
